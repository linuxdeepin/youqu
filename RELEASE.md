...
- 新增 `skipif_not_xxx` 条件跳过逻辑；[PR #62](https://github.com/linuxdeepin/youqu/pull/62) by [@DarkLii](https://github.com/DarkLii)
...
- 修复获取 `commit` 中方法修复数量错误的问题；[@mikigo](https://github.com/mikigo)
